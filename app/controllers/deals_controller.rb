class DealsController < ApplicationController
  ...
  def create
    ...
    Deals.create :user_id => current_user.id, :deal_id => deal_name, :send_address => address, :release_address => release_address, :note => params[:deal][:note]
  ...
  def show
    ...
    @unconfirmed_balance = Bitcoind.deal_balance @deal.deal_id, false
